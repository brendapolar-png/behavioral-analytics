...
```{r}
pwr.p.test(n = 50, sig.level = 0.05, power = 0.8, alternative = "two.sided")
```
...
```{r}
pwr.p.test(n = 50, sig.level = 0.05, h = 0.2, alternative = "two.sided")
```
...
```{r}
pwr.p.test(h = ES.h(0.05, 0.15), sig.level = 0.05, power = 0.8, alternative = "two.sided")
```
...
```{r}
pwr.p.test(h = ES.h(0.5, 0.6), sig.level = 0.05, power = 0.8, alternative = "two.sided")
```


```{r}
pwr.p.test(h = ES.h(0.7, 0.8), sig.level = 0.05, power = 0.8, alternative = "two.sided")
```
